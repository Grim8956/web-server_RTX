            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  id="role"
                  name="role"
                  className="w-full px-4 py-3 border border-gray-300 bg-white/80 backdrop-blur-sm rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-400 transition-all duration-200"
                  value={role}
